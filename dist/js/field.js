...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-quill-field', __webpack_require__(6));
    Vue.component('detail-nova-quill-field', __webpack_require__(9));
    Vue.component('form-nova-quill-field', __webpack_require__(12));
});
...
var update = __webpack_require__(15)("e5d016e6", content, false, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_object_to_formdata__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_laravel_nova__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_quill_dist_quill_core_css__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_quill_dist_quill_snow_css__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ImageUploader__ = __webpack_require__(34);
...
__WEBPACK_IMPORTED_MODULE_3_vue_quill_editor__["Quill"].register('modules/imageUploader', __WEBPACK_IMPORTED_MODULE_6__ImageUploader__["a" /* default */]);
    ...
    computed: {
        options: function options() {
            ...
            return {
                ...
                modules: {
                    toolbar: {
                        container: this.field.toolbar || [[{ 'header': 1 }, { 'header': 2 }], [{ 'align': '' }, { 'align': 'center' }, { 'align': 'right' }, { 'align': 'justify' }], ['bold', 'italic', 'underline', 'strike'], ['blockquote'], [{ 'list': 'ordered' }, { 'list': 'bullet' }], ['clean'], ['link', 'image', 'video']]
                    },
                    imageUploader: {
                        upload: function () {
                            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(file) {
                                var data, _ref2, dataUrl, errors;

                                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                                    while (1) {
                                        switch (_context.prev = _context.next) {
                                            case 0:
                                                data = __WEBPACK_IMPORTED_MODULE_1_object_to_formdata___default()(_extends({
                                                    file: file,
                                                ...
                                                _context.prev = 1;
                                                _context.next = 4;
                                                return Nova.request().post('/nova-vendor/nova-quill-field', data);

                                            case 4:
                                                _ref2 = _context.sent;
                                                dataUrl = _ref2.data.dataUrl;
                                                return _context.abrupt('return', dataUrl);

                                            case 9:
                                                _context.prev = 9;
                                                _context.t0 = _context['catch'](1);
                                                errors = new __WEBPACK_IMPORTED_MODULE_2_laravel_nova__["Errors"](_context.t0.response.data.errors);
...
var ImageUploader = function () {
    function ImageUploader(quill) {
        ...
        this.quill.getModule('toolbar').addHandler('image', this.handle.bind(this));
    ...
    _createClass(ImageUploader, [{
        key: 'readFiles',
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(files, handler) {
                var _this = this;
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                files = [].concat(_toConsumableArray(files)).filter(function (file) {
                                ...
                                return Promise.all(files.map(function (file) {
                                    return _this.options.upload(file);
                                }));

                            case 3:
                                dataUrls = _context.sent;
        ...
        value: function handle() {
            ...
            input.onchange = function () {
                _this2.readFiles(input.files, function (dataUrl) {
        ...
        value: function handleDrop(event) {
            ...
            if (event.dataTransfer && event.dataTransfer.files && event.dataTransfer.files.length) {
                ...
                this.readFiles(event.dataTransfer.files, function (dataUrl) {
                    return _this3.insert(dataUrl);
                });
            }
        }
    }, {
        ...
        value: function insert(dataUrl) {
            ...
            var index = range ? range.index : this.quill.getLength();
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("quill-editor", {
            staticClass: "border border-60 rounded-lg",
